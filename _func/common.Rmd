...
t_basic_info <- file.path(template_path, "summary_basic_info.Rmd")
t_descriptive_stats <- file.path(template_path, "summary_descriptive_stats.Rmd")
t_locations <- file.path(template_path, "summary_locations.Rmd")
t_distribution_time <- file.path(template_path, "summary_distribution_time.Rmd")
t_duplicate_within <- file.path(template_path, "summary_duplicate_within.Rmd")
t_duplicate_across <- file.path(template_path, "summary_duplicate_across.Rmd")
t_observation_counts <- file.path(template_path, "summary_observation_counts.Rmd")
