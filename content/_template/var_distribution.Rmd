...
```{r, t_var_dist4, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 10}
...
```{r, t_var_dist5, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 10, fig.height = 10}
