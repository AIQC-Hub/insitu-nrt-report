...
### Mapped locations of four time spans
 ...
 - **{{time_span1}}**: `r paste0({{time_span1_from1}}, " ~ ", {{time_span1_to1}})`
 - **{{time_span2}}**: `r paste0({{time_span1_from2}}, " ~ ", {{time_span1_to2}})`
 - **{{time_span3}}**: `r paste0({{time_span1_from3}}, " ~ ", {{time_span1_to3}})`
 - **{{time_span4}}**: `r paste0({{time_span1_from4}}, " ~ ", {{time_span1_to4}})`
