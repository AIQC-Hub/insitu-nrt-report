...
### Mapped locations of four time spans
 ...
 - **{{time_span1}}**: `r paste0({{time_span1_from}}, " ~ ", {{time_span1_to}})`
 - **{{time_span2}}**: `r paste0({{time_span2_from}}, " ~ ", {{time_span2_to}})`
 - **{{time_span3}}**: `r paste0({{time_span3_from}}, " ~ ", {{time_span3_to}})`
 - **{{time_span4}}**: `r paste0({{time_span4_from}}, " ~ ", {{time_span4_to}})`
